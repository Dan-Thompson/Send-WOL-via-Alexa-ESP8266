...
const char* friendlyName = "computer"; // Alexa will use this name to identify your device
...
byte remote_MAC_ADD[] = { 0x10, 0xbf, 0x48, 0x7e, 0x5d, 0x8f }; //your MAC Address
...
char* getDateString()
{
  //Any Date/Time will suffice
  return "Wed, 05 Dev 2018 21:47:18 GMT";
}
